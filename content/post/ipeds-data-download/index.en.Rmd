...
authors: []
lastmod: '2023-04-19T21:06:26-07:00'
featured: no
image:
  caption: ''
  focal_point: ''
...
1.  To download IPEDS, we first need to open the [[IPEDS](%5Bhttps://nces.ed.gov/ipeds/use-the-data)](https://nces.ed.gov/ipeds/use-the-data)) website.

![](images/IPEDS1.jpg)

2.  IPEDS website provides multiple options for us to explore. To download data we need, we need to go to "**Survey Data**" and choose "**Custom data files**". ![](images/IPEDS2.jpg)
...
1.  Make sure that you check and understand the variables' definitions before you use them.
